        ...
        <>
            ...
            <div className={"w-screen flex justify-around items-center pt-8"}>
                <div className={"w-3/12"}>
                    <p className={"text-lg text-zinc-900 font-medium mt-4 break-word text-justify"}>Projeto de agenda feito com carinho</p>
            ...
            <footer className={"absolute w-screen bottom-0 text-zinc-600 bg-zinc-300 flex py-4 justify-center"}>
                Pedro Delgado © Todos os direitos reservados
            </footer>
            </NotAuthenticated>
        </>
    );
